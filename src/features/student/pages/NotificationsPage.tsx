...
import { Bell, CheckCheck, Inbox, Info, TriangleAlert as AlertTriangle, CircleAlert as AlertCircle, CircleCheck as CheckCircle2 } from 'lucide-react';
import {
  useStudentNotifications, useMarkNotificationRead, useMarkAllNotificationsRead,
...
export default function NotificationsPage() {
  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        <PageHeader title="Notifications" description="Stay updated on attendance sessions and announcements." />
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Notifications"
        description="Stay updated on attendance sessions and announcements."
        actions={
          unreadCount > 0 && (
      ...
      {notifications.length === 0 ? (
        <EmptyState
          ...
          description="You'll be notified about attendance sessions, announcements, and system updates here."
